            ...
            <table class="table">
                <tbody>
                        ...
                        <td scope="row" style="border: 1px solid #000;">
                            ...
                            <table class="invoice">
                                <tr>
                                    ...
                                    <td>
                                        <p class="m-0">: <?= date("d-m-Y", strtotime($dataAdministrasi->tgl_administrasi)); ?></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <p class="m-0">: <?= $dataAdministrasi->id_administrasi; ?></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <p class="m-0">: <?= $dataAdministrasi->no_refrensi; ?></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr class="bg-white">
                        ...
                        <td scope="row" style="border: 1px solid #000;"><?= $dataAdministrasi->nama_pengujian; ?></td>
                        <td scope="row" style="border: 1px solid #000;"><?= $dataAdministrasi->biaya; ?></td>
                    </tr>
                    <tr class="bg-white">
